...
@server.route('/PaintedLands/')
@server.route('/PaintedLands/Rulebook')
def painted_lands():
    return render_template('PaintedLands.html')


@server.route('/PaintedLands', defaults={'path': ''})
@server.route('/painted_lands', defaults={'path': ''})
@server.route('/painted_lands/<path:path>')
@server.route('/paintedlands', defaults={'path': ''})
@server.route('/paintedlands/<path:path>')
@server.route('/pl', defaults={'path': ''})
@server.route('/pl/<path:path>')
@server.route('/PL', defaults={'path': ''})
@server.route('/PL/<path:path>')
def painted_lands_redirect(path):
    return redirect('/PaintedLands/Rulebook', code=302)
